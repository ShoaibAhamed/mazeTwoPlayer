...
public class Player extends JPanel {
	...
	public Player(int color) { // new construction method with para. color
		if (color == 1) { // if color is 1, set up the first color
			this.setBackground(Color.getHSBColor(.55f, 1, 1));
			this.setSize(Maze.panelSize, Maze.panelSize);
		}else if(color == 2){ // else set up the other color
